...
function ClusterCard({ item }: { item: ClusterItem }) {
  return (
    <Link
      href={item.href}
      className="flex flex-col shrink-0 w-32 rounded-2xl border border-border/50 bg-card hover:border-foreground/20 hover:bg-accent/20 overflow-hidden transition-all"
    >
